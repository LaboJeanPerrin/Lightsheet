...
try
    ...
    addParameter(p, 'LengthUnit', this.Units.Length, @(x) ismember(x, {'m', 'mm', 'um', '�m'}));
...
switch unit
    ...
    case 'm'
        switch target
            case 'm', out = val;
            case 'mm', out = val*1e3;
            case {'um', '�m'}, out = val*1e6;
        end
    case 'mm'
        switch target
            case 'm', out = val*1e-3;
            case 'mm', out = val;
            case {'um', '�m'}, out = val*1e3;
        end
    case {'um', '�m'}
        switch target
            case 'm', out = val*1e-6;
    ...
    case 'm/V'
        switch target
            ...
            case {'um/V', '�m/V'}, out = val*1e6;
        end
    case 'mm/V'
        switch target
            case 'm/V', out = val*1e-3;
            case 'mm/V', out = val;
            case {'um/V', '�m/V'}, out = val*1e3;
        end
    case {'um/V', '�m/V'}
        switch target
            case 'm/V', out = val*1e-6;
            case 'mm/V', out = val*1e-3;
            case {'um/V', '�m/V'}, out = val;
        end
