...
this.UI.VIpath = uicontrol(Tab_Settings, 'Style', 'edit', ...
    'Tag', 'VIpath', ...
    'String', 'C:\Users\LJP\Documents\Thomas\Kollmorgen\Monitor_position_GUI_VB.vi', ...
    'HorizontalAlignment', 'left', ...
...
% --- Conditional horizontal mirror offset -----------------------------------
xHMoffset = 440;
yHMoffset = 10;
...
annotation(Tab_Control, 'rectangle', ...
    ...
    'LineStyle', 'none', ...
    'FaceColor', [1 1 1]*0.94, ...
    'Position', [xHMoffset yHMoffset 150 60]);
uicontrol(Tab_Control, 'Style', 'text', ...
    'String', 'Horizontal mirror conditional offset', ...
    'Position', [xHMoffset yHMoffset+35 150 60], ...
    'FontWeight', 'bold', ...
    'ForegroundColor', TitleColor, ...
    'HorizontalAlignment', 'center');
...
% Text
uicontrol(Tab_Control, 'Style', 'text', 'HorizontalAlignment', 'right', ...
    'String', 'Critical height (um)', ...
    'Position', [xHMoffset+2 yHMoffset+40 97 20]);

% Edit
this.UI.CriticalHeight = uicontrol(Tab_Control, 'Style', 'edit', ...
    'Tag', 'CriticalHeight', ...
    'String', 0, ...
    'Position', [xHMoffset+100 yHMoffset+45 40 20], ...
    'Enable', 'on');
...
uicontrol(Tab_Control, 'Style', 'text', 'HorizontalAlignment', 'right', ...
    'String', 'HM offset (um)', ...
    'Position', [xHMoffset+2 yHMoffset+2 97 20]);

% Edit
this.UI.HMoffset = uicontrol(Tab_Control, 'Style', 'edit', ...
    'Tag', 'HMoffset', ...
    'String', 0, ...
    'Position', [xHMoffset+100 yHMoffset+5 40 20], ...
    'Enable', 'on');
