...
% --- Run
this.UI.Stim = uicontrol(this.Figures.Main, ...
    'Style', 'togglebutton', ...
    'Tag', 'Stim', ...
    'String', 'Stim', ...
    'Position', [450 455 100 40]);

% --- Error
this.UI.Error = uicontrol('Style', 'togglebutton', ...
    'String', 'ERROR', ...
    'Tag', 'Error', ...
...
this.UI.HM_Shape = uicontrol(Tab_Independent, 'Style', 'popupmenu', ...
    'Tag', 'HM_Shape', ...
    'String', {'Sine', 'Sawtooth', 'Triangle'}, ... % 'Value', 3, ...
...
Html = [Html '<p style="font-family: Arial; font-size:18px; color: white; margin-bottom: 30px;">Reloading DAQ control</p>'];
