...
if nargin && strcmp(varargin{1}, 'UpdateScreen')
    ...
    bb = 40;
    pos = [screen(1)+100 screen(4)/2+bb-100 screen(2)+screen(3)/2 screen(4)/2-bb];
...
% ADDED 15/03/2022
Tab_Stimulation = uitab(this.UI.MainTab, ...
    'Title', 'Stimulation', ...
    'Tag', 'Stimulation', ...
    'BackgroundColor', [1 1 1]);
...
this.UI.VIpath = uicontrol(Tab_Settings, 'Style', 'edit', ...
    'Tag', 'VIpath', ...
    'String', 'C:\Users\LJP\Documents\Labview\Master.vi', ...
    'HorizontalAlignment', 'left', ...
...
% === Stimulation tab (ADDED 15/03/2022) =========================================================

xPos = 10;
yPos = 265;

% --- Decoration
annotation(Tab_Stimulation, 'rectangle', ...
    'Units', 'pixel', ...
    'LineStyle', 'none', ...
    'FaceColor', [1 1 1]*0.94, ...
    'Position', [xPos yPos-20 700 250]);


this.UI.stim_time = axes(Tab_Stimulation, ...
    'Units', 'pixel', ...
    'Position', [60 50 670 180], ...
    'FontSize', 8);

% --- Save params
this.UI.SaveParams2 = uicontrol(Tab_Stimulation, ...
    'Style', 'pushbutton', ...
    'Tag', 'SaveParam2', ...
    'String', 'Save Parameters', ...
    'Position', [xPos+590 yPos+50 90 30], ...
    'Callback', @this.saveParams);


%%% 04/08/2023
this.UI.SubStim = uitabgroup(Tab_Stimulation, ...
    'Units', 'pixel', ...
    'Tag', 'SubStim', ...
    'Position', [xPos+20 yPos-20 550 170]);

SubStim_time = uitab(this.UI.SubStim, ...
    'Title', 'Stim time', ...
    'Tag', 'SubStim_time', ...
    'BackgroundColor', [1 1 1]*0.94);

SubStim_Cycle = uitab(this.UI.SubStim, ...
    'Title', 'Stim cycle', ...
    'Tag', 'SubStim_Cycle', ...
    'BackgroundColor', [1 1 1]*0.94);
...
uicontrol(SubStim_time, 'Style', 'text', ...
    'String', 'Intra-stimulation params', ...
    'Position', [xPos_2 yPos_2+100 250 20], ...
    'FontWeight', 'bold', ...
    'ForegroundColor', TitleColor, ...
    'HorizontalAlignment', 'center');

uicontrol(SubStim_time, 'Style', 'text', ...
    'String', 'Inter-repetition params', ...
    'Position', [xPos_2+30+250 yPos_2+100 200 20], ...
    'FontWeight', 'bold', ...
    'ForegroundColor', TitleColor, ...
    'HorizontalAlignment', 'center');

uicontrol(SubStim_Cycle, 'Style', 'text', ...
    'String', 'Intra-stimulation params', ...
    'Position', [xPos_2 yPos_2+100 250 20], ...
    'FontWeight', 'bold', ...
    'ForegroundColor', TitleColor, ...
...
uicontrol(SubStim_Cycle, 'Style', 'text', ...
    'String', 'Inter-repetition params', ...
    'Position', [xPos+250+30 yPos_2+100 200 20], ...
    'FontWeight', 'bold', ...
    'ForegroundColor', TitleColor, ...
    'HorizontalAlignment', 'center');
%%% --- SubStim time params

% --- Starting time offset (for camera readout)

% Text
uicontrol(SubStim_time, 'Style', 'text', 'HorizontalAlignment', 'right', ...
    'String', 'Starting time', ...
    'Position', [xPos_2 yPos_2+80 130 20]);

% Edit
this.UI.init_time_offset = uicontrol(SubStim_time, 'Style', 'edit', ...
    'Tag', 'init_time_offset', ...
    'String', 11, ...
    'Position', [xPos_2+150 yPos_2+80+3 40 20], ...
    'Callback', @this.setStim);

% --- Stimulation duration

% Text
uicontrol(SubStim_time, 'Style', 'text', 'HorizontalAlignment', 'right', ...
    'String', 'Trig duration', ...
    'Position', [xPos_2 yPos_2+60 130 20]);

% Edit
this.UI.stim_duration = uicontrol(SubStim_time, 'Style', 'edit', ...
    'Tag', 'stim_duration', ...
    'String', 1, ...
    'Position', [xPos_2+150 yPos_2+60+3 40 20], ...
    'Callback', @this.setStim);


% --- Intra-stimulation duration

% Text
uicontrol(SubStim_time, 'Style', 'text', 'HorizontalAlignment', 'right', ...
    'String', 'Intra-stimulation duration', ...
    'Position', [xPos_2 yPos_2+40 130 20]);

% Edit
this.UI.intra_stim_duration = uicontrol(SubStim_time, 'Style', 'edit', ...
    'Tag', 'intra_stim_duration', ...
    'String', 1000, ...
    'Position', [xPos_2+150 yPos_2+40+3 40 20], ...
    'Callback', @this.setStim);
...
% Text
uicontrol(SubStim_time, 'Style', 'text', 'HorizontalAlignment', 'right', ...
    'String', 'Number of stimulations', ...
    'Position',  [xPos_2 yPos_2+20 130 20]);

% Edit
this.UI.nb_stim = uicontrol(SubStim_time, 'Style', 'edit', ...
    'Tag', 'nb_stim', ...
    'String', 10, ...
    'Position', [xPos_2+150 yPos_2+20+3 40 20], ...
    'Callback', @this.setStim);
...
% Text
uicontrol(SubStim_time, 'Style', 'text', 'HorizontalAlignment', 'right', ...
    'String', 'Delay Trigger', ...
    'Position', [xPos_2 yPos_2+0 130 20]);

% Edit
this.UI.delay_trig = uicontrol(SubStim_time, 'Style', 'edit', ...
    'Tag', 'delay_trig', ...
    'String', 11, ...
    'Position', [xPos_2+150 yPos_2+0+3 40 20], ...
    'Callback', @this.setStim);

%%% Inter-stim global repetition

% --- Number of repetitions inter

% Text
uicontrol(SubStim_time, 'Style', 'text', 'HorizontalAlignment', 'right', ...
    'String', 'Number of repetitions', ...
    'Position', [xPos_2+10+250 yPos_2+80 130 20]);

% Edit
this.UI.nb_of_repetitions = uicontrol(SubStim_time, 'Style', 'edit', ...
    'Tag', 'nb_of_repetitions', ...
    'String', 1, ...
    'Position', [xPos_2+155+250 yPos_2+80+3 40 20], ...
    'Callback', @this.setStim);

% --- Inter-repetition duration

% Text
uicontrol(SubStim_time, 'Style', 'text', 'HorizontalAlignment', 'right', ...
    'String', 'Inter-repetition duration', ...
    'Position', [xPos_2+10+250 yPos_2+60 130 20]);

% Edit
this.UI.inter_duration = uicontrol(SubStim_time, 'Style', 'edit', ...
    'Tag', 'inter_duration', ...
    'String', 1000, ...
    'Position', [xPos_2+155+250 yPos_2+60+3 40 20], ...
    'Callback', @this.setStim);

%%% --- SubStim cycle params

% --- Starting time offset (for camera readout)

% Text
uicontrol(SubStim_Cycle, 'Style', 'text', 'HorizontalAlignment', 'right', ...
    'String', 'Starting Cycle', ...
    'Position', [xPos_2 yPos_2+80 130 20]);

% Edit
this.UI.starting_cycle = uicontrol(SubStim_Cycle, 'Style', 'edit', ...
    'Tag', 'starting_cycle', ...
    'String', 10, ...
    'Position', [xPos_2+150 yPos_2+80+3 40 20], ...
    'Callback', @this.setStim);
...
% Text
uicontrol(SubStim_Cycle, 'Style', 'text', 'HorizontalAlignment', 'right', ...
    'String', 'Layers label (1,2,3...)', ...
    'Position',  [xPos_2 yPos_2+60 130 20]);

% Edit
this.UI.layers_numbers = uicontrol(SubStim_Cycle, 'Style', 'edit', ...
    'Tag', 'layers_numbers', ...
    'String', '1,2,3', ...
    'Position', [xPos_2+150 yPos_2+60+3 40 20], ...
    'Callback', @this.setStim);

% --- Number of repetition over cycles

% Text
uicontrol(SubStim_Cycle, 'Style', 'text', 'HorizontalAlignment', 'right', ...
    'String', 'Repetition over cycles', ...
    'Position',  [xPos_2 yPos_2+40 130 20]);

% Edit
this.UI.cycle_rep = uicontrol(SubStim_Cycle, 'Style', 'edit', ...
    'Tag', 'cycle_rep', ...
    'String', '1', ...
    'Position', [xPos_2+150 yPos_2+40+3 40 20], ...
    'Callback', @this.setStim);
...
% Inter-stim global repetition cycle
...
% Edit
this.UI.nb_of_repetitions_cycle = uicontrol(SubStim_Cycle, 'Style', 'edit', ...
    'Tag', 'nb_of_repetitions_cycle', ...
    'String', 1, ...
    'Position', [xPos_2+155+250 yPos_2+80+3 40 20], ...
    'Callback', @this.setStim);
...
% Text
uicontrol(SubStim_Cycle, 'Style', 'text', 'HorizontalAlignment', 'right', ...
    'String', 'Inter-repetition cycle', ...
    'Position', [xPos_2+10+250 yPos_2+60 130 20]);

% Edit
this.UI.inter_duration_cycle = uicontrol(SubStim_Cycle, 'Style', 'edit', ...
    'Tag', 'inter_duration_cycle', ...
    'String', 1000, ...
    'Position', [xPos_2+155+250 yPos_2+60+3 40 20], ...
    'Callback', @this.setStim);

% % --- refreshStim (Added 25/06/2022)
% 
% this.UI.refreshStim = uicontrol(Tab_Stimulation, ...
%     'Style', 'pushbutton', ...
%     'Tag', 'Refresh Stim', ...
%     'String', 'Refresh Stim', ...
%     'Position', [xPos+255 yPos+10 90 90], ...
%     'Callback', @this.refreshStim);


%addlistener(this.Run.Name, 'Value', 'PostSet', @thisUpdateVI);
