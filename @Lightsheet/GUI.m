...
annotation(Tab_Stimulation, 'rectangle', ...
    ...
    'LineStyle', 'none', ...
    'FaceColor', [1 1 1]*0.94, ...
    'Position', [xPos yPos-20 470 250]);

uicontrol(Tab_Stimulation, 'Style', 'text', ...
    'String', 'Intra-stimulation parameters', ...
    'Position', [xPos yPos+115 250 20], ...
    'FontWeight', 'bold', ...
    'ForegroundColor', TitleColor, ...
    'HorizontalAlignment', 'center');

uicontrol(Tab_Stimulation, 'Style', 'text', ...
    'String', 'Inter-repetition parameters', ...
    'Position', [xPos+250 yPos+115 200 20], ...
    'FontWeight', 'bold', ...
    'ForegroundColor', TitleColor, ...
    'HorizontalAlignment', 'center');
...
this.UI.stim_time = axes(Tab_Stimulation, ...
    'Units', 'pixel', ...
    'Position', [60 50 290 180], ...
    'FontSize', 8);

% --- Starting time offset (for camera readout)

% Text
uicontrol(Tab_Stimulation, 'Style', 'text', 'HorizontalAlignment', 'right', ...
    'String', 'Starting time', ...
    'Position', [xPos+10 yPos+82 130 20]);

% Edit
this.UI.init_time_offset = uicontrol(Tab_Stimulation, 'Style', 'edit', ...
    'Tag', 'init_time_offset', ...
    'String', 11, ...
    'Position', [xPos+155 yPos+85 40 20], ...
...
uicontrol(Tab_Stimulation, 'Style', 'text', 'HorizontalAlignment', 'right', ...
    ...
    'Position', [xPos+10 yPos+57 130 20]);

% Edit
this.UI.stim_duration = uicontrol(Tab_Stimulation, 'Style', 'edit', ...
    'Tag', 'stim_duration', ...
    'String', 1, ...
    'Position', [xPos+155 yPos+60 40 20], ...
    'Callback', @this.setStim);
...
uicontrol(Tab_Stimulation, 'Style', 'text', 'HorizontalAlignment', 'right', ...
    ...
    'Position', [xPos+10 yPos+32 130 20]);

% Edit
this.UI.intra_stim_duration = uicontrol(Tab_Stimulation, 'Style', 'edit', ...
    'Tag', 'intra_stim_duration', ...
    'String', 1000, ...
    'Position', [xPos+155 yPos+35 40 20], ...
    'Callback', @this.setStim);
...
uicontrol(Tab_Stimulation, 'Style', 'text', 'HorizontalAlignment', 'right', ...
    ...
    'Position', [xPos+10 yPos+7 130 20]);

% Edit
this.UI.nb_stim = uicontrol(Tab_Stimulation, 'Style', 'edit', ...
    'Tag', 'nb_stim', ...
    'String', 10, ...
    'Position', [xPos+155 yPos+10 40 20], ...
    'Callback', @this.setStim);
...
uicontrol(Tab_Stimulation, 'Style', 'text', 'HorizontalAlignment', 'right', ...
    ...
    'Position', [xPos+10 yPos-18 130 20]);

% Edit
this.UI.delay_trig = uicontrol(Tab_Stimulation, 'Style', 'edit', ...
    'Tag', 'delay_trig', ...
    'String', 11, ...
    'Position', [xPos+155 yPos-15 40 20], ...
    'Callback', @this.setStim);
...
uicontrol(Tab_Stimulation, 'Style', 'text', 'HorizontalAlignment', 'right', ...
    ...
    'Position', [xPos+10+250 yPos+82 130 20]);

% Edit
this.UI.nb_of_repetitions = uicontrol(Tab_Stimulation, 'Style', 'edit', ...
    'Tag', 'nb_of_repetitions', ...
    'String', 1, ...
    'Position', [xPos+155+250 yPos+85 40 20], ...
    'Callback', @this.setStim);
...
uicontrol(Tab_Stimulation, 'Style', 'text', 'HorizontalAlignment', 'right', ...
    ...
    'Position', [xPos+10+250 yPos+57 130 20]);

% Edit
this.UI.inter_duration = uicontrol(Tab_Stimulation, 'Style', 'edit', ...
    'Tag', 'inter_duration', ...
    'String', 1000, ...
    'Position', [xPos+155+250 yPos+60 40 20], ...
    'Callback', @this.setStim);
